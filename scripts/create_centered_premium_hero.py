...
export function Hero({ forecast, hour, cursor, consensus, cityAggregate }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      {/* ── 4. Floating Video Theme Switcher Pill in Top Bar Center ── */}
      <div
        style={{
          position: "fixed",
          top: "0.65rem",
            ...
            return (
              <button
                ...
                style={{
                  ...
                  boxShadow: isActive ? "0 2px 8px rgba(0, 0, 0, 0.2), inset 0 1px 1px rgba(255, 255, 255, 0.3)" : "none",
                  cursor: "pointer",
      ...
      {/* ── 5. Main Centered 100% Pure Optical Crystal Glass Showcase ── */}
      <motion.div
        style={{
          width: "100%",
          maxWidth: "650px",
...
print("Hero.tsx generated with near-invisible ghost-glass transparency!")
